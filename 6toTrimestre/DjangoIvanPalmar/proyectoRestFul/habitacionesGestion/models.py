...
class tb_estado(models.Model):
    codigo_ed = models.IntegerField(primary_key = True, default = 0, verbose_name = 'Codigo del Estado')
    tipo_ed = models.CharField(max_length=70, verbose_name = 'Tipo de Estado')

class tb_tipoHabitacion(models.Model):
    codigo_tpH = models.IntegerField(primary_key=True,default=0, verbose_name='Codigo del tipo de habitacion')
