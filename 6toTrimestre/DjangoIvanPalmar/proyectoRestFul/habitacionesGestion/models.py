...
class tb_mobiliario(models.Model):
    ...
    codigo_pMb = models.ForeignKey("tb_paqueteMobiliario", default = 1, verbose_name="Codigo del paquete de mobiliario", on_delete=models.CASCADE)
    codigo_tpH = models.ForeignKey("tb_tipoHabitacion", default = 1, verbose_name="Codigo del tipo de habitacion", on_delete=models.CASCADE)
