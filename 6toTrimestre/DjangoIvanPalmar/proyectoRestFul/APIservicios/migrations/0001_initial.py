    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('codigo_cat', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='APIservicios.tb_categoria', verbose_name='Categoria del servicio')),
            ],
        ),
        migrations.CreateModel(
            name='tb_consumo',
            fields=[
                ('numero_con', models.IntegerField(primary_key=True, serialize=False, verbose_name='Codigo del consumo')),
                ...
                ('codigo_ser', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='APIservicios.tb_servicio', verbose_name='Codigo del servicio consumido')),
            ],
        ),
    ]
