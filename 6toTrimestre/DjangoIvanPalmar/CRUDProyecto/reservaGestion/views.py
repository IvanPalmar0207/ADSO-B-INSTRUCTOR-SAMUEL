...
def insertarReserva(request):
    try:
        ...
        if fechaLlegada<fechaSalida:        
            reserva = tb_reserva.objects.create(numeroDocumento_cli = numeroDoc, fechaInicio_res = fechaLlegada, fechaSalida_res = fechaSalida, cantidadJovenes_res =cantidadJovenes, cantidadAdultos_res = cantidadAdultos, codigo_hab = tipoHabitacion)
        else:
