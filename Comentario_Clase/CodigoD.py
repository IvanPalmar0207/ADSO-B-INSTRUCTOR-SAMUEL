def edad(): #Se crea una funcion llamada edad la cual no contiene ningun parametro.
    try: #Se usa la palabra reservada try para evaluar o tratar el codigo y verificar si tiene errores.
