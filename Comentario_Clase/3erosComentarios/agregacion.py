#Esto es agregacion ya que los objetos instanciados de cada clase pueden ser combinados pero si se elimina uno, los demas seguiran existiendo en memoria y su tiempo en memoria se extendera.
class Aprendiz: #Se hace la clase usando la palabra reservada class y se le asigna su respectivo nombre el cual es Aprendiz.
...
class Curso: #Se crea una nueva clase con la palabra reservada class y que llevara por nombre Curso:
