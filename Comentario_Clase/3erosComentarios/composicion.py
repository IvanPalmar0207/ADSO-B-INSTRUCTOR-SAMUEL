...
class Curso: #Se crea una clase con la palabra reservada class y se le asigna su respectivo nombre el cual sera 'Curso'.
...
class Aprendiz: #Se crea una nueva clase con la palabra reservada class la cual llevara como nombre Aprendiz.
